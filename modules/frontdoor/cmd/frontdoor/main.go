...
var cfg *internal.FrontdoorConfig

func init() {
	ctx := context.Background()

	cfg = envconfig.ParseEnv(&internal.FrontdoorConfig{})
...
func main() {
	...
	deepHealthServer := servicechecks.NewDeepHealthServer()
	httpServer.RegisterGrpcServer(func(s *grpc.Server) {
		grpc_health_v1.RegisterHealthServer(s, healthServer)
		grpc_deephealth_v1.RegisterDeepHealthServer(s, deepHealthServer)
	})
